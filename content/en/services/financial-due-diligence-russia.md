---
title: "Financial Due Diligence in Russia | Accountant & Co."
...
1. statutory and management financial statements;
2. trial balances and general-ledger extracts;
3. revenue and margin data;
4. bank and debt schedules;
5. receivables and payables ageing;
6. tax returns and reconciliations made available for review;
7. significant contracts and related-party information relevant to the financial analysis.
...
See [Audit Services](/en/services/audit-services/), [Financial Modeling](/en/services/financial-modeling/) and [Cross-Border Finance](/en/services/cross-border-finance/).

[Contact Accountant & Co.](/en/contacts/) to define the transaction, target entity, review period and available data.
