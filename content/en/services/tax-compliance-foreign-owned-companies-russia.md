---
title: "Tax Compliance for Foreign-Owned Companies in Russia | Accountant & Co."
...
- preparation and review workflow for recurring tax filings;
- reconciliation of tax registers to accounting records;
- review of supporting documents for material transactions;
- tracking of tax balances, payments and open items;
- intercompany transaction documentation support;
- coordination of questions between local finance and overseas headquarters;
- preparation of files and explanations requested during tax or audit review.
...
See [Accounting for Foreign Companies in Russia](/en/services/accounting-for-foreign-companies-russia/), [Accounting for a Russian Subsidiary or Branch](/en/services/accounting-russian-subsidiary-branch/) and [Cross-Border Finance](/en/services/cross-border-finance/).

[Contact Accountant & Co.](/en/contacts/) to discuss the operating structure and current compliance process.
